...
venue: "BC Cancer Research Centre"        # brief name of host site without address (e.g., "Euphoric State University")
...
helper: ["Elizabeth Chun"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
